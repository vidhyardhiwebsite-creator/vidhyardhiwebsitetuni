  ...
  const F = ({ name, label, placeholder, half }) => (
    <div className={half ? "" : "col-span-2"}>
      ...
      <input value={form[name]} onChange={e => setForm(f => ({ ...f, [name]: e.target.value }))} placeholder={placeholder}
        className="w-full bg-[#0A0A0A] border border-[#D4AF37]/20 rounded-lg px-3 py-2.5 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-[#D4AF37]" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-[#111] border border-[#D4AF37]/20 rounded-xl p-6 h-fit sticky top-20">
          ...
          <button
            ...
            disabled={paying || !selectedId || items.length === 0}
