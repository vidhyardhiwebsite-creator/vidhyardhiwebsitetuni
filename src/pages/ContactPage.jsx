          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input required value={name} onChange={e => setName(e.target.value)}
                className="w-full bg-[#FAF8F5] border border-[#E8E0D5] rounded-lg px-3 py-2.5 text-sm text-[#1A1A2E] focus:outline-none focus:border-[#1B2B5E]" placeholder="Your name" />
            </div>
            <div>
